...
# Source File: C:\Users\assist07\Documents\SAPIEN\PowerShell Studio\Files\Startatore_GUI_Alpha_0.1.TempPoint.psf
#------------------------------------------------------------------------
...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       09/09/2021 08:49
     Generated by:       assist07
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
#----------------------------------------------
function Show-Startatore_GUI_Alpha_0_1_TempPoint_psf {
...
"@ -IgnoreWarnings | Out-Null
	...
	{
		$ResultBox.Text = "Errore! La connessione non funziona, cambia ip o controlla il cavo"
	...
	$button1721620153_Click= {
		...
		$ResultBox.Text = try
		{
			Test-Connection ntced -ErrorAction Stop
		}
		
		catch
		
		{
			$ResultBox.Text = "Errore Fatale! Il PC non risulta in rete, controlla il cavo o che l'IP sia libero"
		}
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			...
			$ResultBox.remove_TextChanged($ResultBox_TextChanged)
	...
	$formLoStartatore.ClientSize = '514, 320'
	...
	$labelLoStartatore.Location = '204, 19'
...
4rQeIWq5SCJBEgiQRIIkESCJBEgiQRf/2Q==')
	...
	$progressbaroverlay1.Size = '347, 36'
	...
	$ResultBox.Size = '459, 186'
	$ResultBox.TabIndex = 0
	$ResultBox.Text = ''
	$ResultBox.add_TextChanged($ResultBox_TextChanged)
	#
	# tooltip1
	#
...
#Call the form
Show-Startatore_GUI_Alpha_0_1_TempPoint_psf | Out-Null
